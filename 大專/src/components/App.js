...
export default function App() {
    return (
        <React.Fragment>
            ...
            <Route exact path='/marian/memberinside/:memberId' component={MemberInside} /> */}
            <Route exact path='/marian/member/:memberId' component={MemberInside} />
            <Route exact path='/marian/cart' component={Cart} />
            {/* <Route exact path='/marian/NewsSwiper' component={NewsSwiper} /> */}
            <Footer />
        </React.Fragment>
    )
}
